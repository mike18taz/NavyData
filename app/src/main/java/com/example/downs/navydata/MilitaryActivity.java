...
public class MilitaryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabLayout.setTabTextColors(Color.YELLOW, Color.MAGENTA);
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_military, container, false);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
                switch (position) {
                    case 0:
                        MilitaryFragment tab1 = new MilitaryFragment();
                        return tab1;
                    case 1:
                        AirForceFragment tab2 = new AirForceFragment();
                        return tab2;
                    case 2:
                        ArmyFragment tab3 = new ArmyFragment();
                        return tab3;
                    case 3:
                        CoastGuardFragment tab4 = new CoastGuardFragment();
                        return tab4;
                    case 4:
                        MarinesFragment tab5 = new MarinesFragment();
                        return tab5;
                    case 5:
                        NavyFragment tab6 = new NavyFragment();
                        return tab6;
                    default:
                        return null;
                }
